...
The Berry phase paper uses~$H=-½D_{xx}+x²$.  In this case the
eigenstate has~$σ=2^{-1/4}$, with~$ω₀=1\over\sqrt2$.  The convention
is~$l₀=\sqrt2σ$, so this gives~$l₀=1$.
